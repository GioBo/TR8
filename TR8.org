#+TITLE: Org file for managing thr TR8 project
...
* Notes
  ...
  lo script generate_Biolflor_lu.Rd e il risultante dataset
  biolflor_lu sono stati inseriti in .Rbuildignore poiché sono utili
  per me per ricreare i dataset necessari, ma non servono al package

* Issues [28/30]

** TODO issue#32						      :email:

   - email a jonathan storkey per chiedere se si può includere nel
